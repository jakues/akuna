        ...
        <div class="w-full max-w-md p-4 bg-base-100 border border-gray-200 rounded-lg shadow sm:p-6 md:p-8">
            ...
            <form class="space-y-6" method="POST" action="">
                ...
                <div class="relative z-0 w-full mb-6 group">
                    ...
                    <label for="email"
                        class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-primary-content peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Email</label>
                </div>
                <div class="relative z-0 w-full mb-6 group">
